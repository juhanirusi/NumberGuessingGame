class UserHints:
    ...
    def user_hint_1(self, answer, guess):
        ...
        if guess in range(from_number, to_number):
            print(
                f"Not quite. But you're right, the number is between {from_number} and {to_number}.")
        else:
            print(
                f"Nope. Let me give you a hint, the number is between {from_number} and {to_number}.")
    ...
    def user_hint_3(self, answer, guess):
        if guess < answer:
            print(
                "That's not the correct answer either. The correct answer is HIGHER than your guess.")
        else:
            print(
                "That's not the correct answer either. The correct answer is LOWER than your guess.")
    ...
    def famous_number_hint(self, answer):
        ...
        match answer:
            case 99:
                print(
                    "This number is also the jersey number of the most successful ice hockey player\n")
            case 8:
